...
export const validationRules: Record<keyof UserFormModel, any> = {
    username: {
        required: 'Username is required',
        minLength: { value: 2, message: 'Username must be at least 3 characters' },
    ...
    email: {
        ...
        maxLength: { value: 30, message: 'Email must be no more than 30 characters' },
    },
    city: {
        required: 'City is required',
        minLength: { value: 3, message: 'City must be at least 3 characters' },
        maxLength: { value: 30, message: 'City must be no more than 50 characters' },
    },
    street: {
        required: 'Street is required',
        maxLength: { value: 20, message: 'Street must be no more than 100 characters' },
    },
    suite: {
        required: 'Suite is required',
        minLength: { value: 3, message: 'Suite must be at least 3 characters' },
        maxLength: { value: 10, message: 'Suite must be less than 20 characters' },
    },
};
